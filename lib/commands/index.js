...
program
	.command('pkg <action> <module>')
	.description('install,update or remove optional otrtalk modules such as "otr4"')
	.action(function (action, pkg) {
		var _cmd = require("./cmd-pkg.js");
		cmd = new _cmd(UI, action, pkg);
	});
