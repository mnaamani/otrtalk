...
program
	...
	.action(function (alias) {
		var _cmd = require("./chat_connect.js");
...
program
	...
	.action(function (app, profile, id) {
		var _cmd = require("./import-key.js");
...
program
	...
	.action(function () {
		var _cmd = require("./im-buddies.js");
		cmd = new _cmd(UI);
	});
